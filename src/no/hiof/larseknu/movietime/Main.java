...
public class Main {
    ...
    private static void lagOgSkrivUtInformasjonOmEtParFilmer() {
        ...
        System.out.println("------------------------------");
        System.out.println(shawshankRedemption.toString() + " - regisert av " + shawshankRedemption.getRegissor().hentNavn());
        for (Rolle enRolle : shawshankRedemption.getRolleListe())
            System.out.println(enRolle.toString());
        System.out.println("------------------------------");
        System.out.println(coco.toString() + " - regisert av " + coco.getRegissor().hentNavn());
    ...
    private static void lagOgSkrivUtInformasjonOmStrangerThings() {
        ...
        for (Episode episode : episodeListe) {
            System.out.println(episode + " - regisert av " + episode.getRegissor().hentNavn());
        }
